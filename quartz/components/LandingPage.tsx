...
export default ((opts?: Options) => {
  const LandingPage: QuartzComponent = ({ displayClass, cfg }: QuartzComponentProps) => {
    const name = opts?.name ?? "Stone"
    const title = opts?.title ?? "AI Explorer & Product Builder"
    const subtitle = opts?.subtitle ?? "Exploring AI, building products, sharing insights"
    const social = opts?.socialLinks ?? {}
        ...
        <div class="landing-content">
          <div class="hero-section">
            <div class="glitch-wrapper">
              <h1 class="hero-title" data-text={`Hi, I'm ${name}`}>
            ...
            <div class="cta-buttons">
              <a href="/notes" class="cta-primary">
                <span class="cta-icon">
          ...
          <div class="feature-cards">
            <a href="/notes" class="feature-card">
              ...
              <h3>AI Notes</h3>
              <p>Learning notes on AI/ML concepts, models, and techniques</p>
            </a>
            ...
            <a href="/projects" class="feature-card">
              ...
              <h3>Projects</h3>
              <p>AI applications and experiments in production</p>
            </a>
            ...
            <a href="/blog" class="feature-card">
              ...
              <h3>Blog</h3>
              <p>Insights, tutorials, and thoughts on AI and tech</p>
            </a>
          </div>
          ...
          <div class="social-links">
            ...
            {social.twitter && (
              <a href={social.twitter} class="social-link" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            ...
            {social.email && (
              <a href={`mailto:${social.email}`} class="social-link" aria-label="Email">
